...
static unsigned int ng8[] = {250U, 0U};
...
LAB31:    if (*((unsigned int *)t5) < *((unsigned int *)t4))
        goto LAB30;
...
LAB35:    xsi_set_current_line(41, ng0);
    ...
    t2 = ((char*)((ng4)));
    memset(t6, 0, 8);
    xsi_vlog_unsigned_minus(t6, 11, t3, 11, t2, 10);
    t4 = (t0 + 4072);
    xsi_vlogvar_wait_assign_value(t4, t6, 0, 0, 11, 0LL);
...
LAB45:    if (*((unsigned int *)t5) < *((unsigned int *)t4))
        goto LAB44;
...
LAB59:    if (*((unsigned int *)t5) < *((unsigned int *)t4))
        goto LAB58;
...
LAB73:    if (*((unsigned int *)t5) < *((unsigned int *)t4))
        goto LAB72;
...
extern void work_m_05192227231930161797_4224876457_init()
{
	static char *pe[] = {(void *)Cont_14_0,(void *)Always_19_1};
	xsi_register_didat("work_m_05192227231930161797_4224876457", "isim/main_tb_isim_beh.exe.sim/work/m_05192227231930161797_4224876457.didat");
